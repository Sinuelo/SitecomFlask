...
from comunidadeimpressionadora import database, app, bcrypt
...
def toggle_dark_mode():
    dark_mode = not session.get('dark_mode', False)
...
def login():
    ...
    if form_login.validate_on_submit() and 'botao_submit_login' in request.form:
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha,form_login.senha.data):
            ...
            flash(f'Você fez login usando o email {form_login.email.data}','alert-success')  # exibir mensagem de login bem sucedido
